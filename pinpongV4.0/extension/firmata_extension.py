...
class AudioAnalyzerExtension:
  def __init__(self, board=None, strobe_pin=None, RST_pin=None, DC_pin=None):
    ...
    self.DC_pin,self.DC_apin = board.res["get_pin"](DC_pin)
    self.RST_pin,self.RST_apin = board.res["get_pin"](RST_pin)
    self.strobe_pin,self.strobe_apin = board.res["get_pin"](strobe_pin)
...
class HX711Extension:
  def __init__(self, board, dout_pin, sck_pin = 2121, scale = None):
    ...
    self.dout_pin,self.dout_apin = board.res["get_pin"](dout_pin)
    self.sck_pin,self.sck_apin = board.res["get_pin"](sck_pin)
    self.scale = scale
