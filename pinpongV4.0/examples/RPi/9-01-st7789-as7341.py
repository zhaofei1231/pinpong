...
lcd.set_font(font="msyh", width = 30, height = 30)
...
def get_spectrum_data_data():
  ...
  return  {data1.adf1,data1.adf2,data1.adf3,data1.adf4, data2.adf5,data2.adf6,data2.adf7,data2.adf8}
...
while True:
  #获取数据
  spectrum_data = asxxx.get_spectrum__data()
